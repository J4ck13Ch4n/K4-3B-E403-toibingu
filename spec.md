...
Bốn lớp sử dụng trong spec: ① thiếu căn cứ/lỗi hệ thống; ② chưa đủ rõ để kết luận; ③ ngoài phạm vi hoặc đổi chỉ thị; ④ đặc thù học tập. Chưa có `02-guide.md` trong repo để đối chiếu tên gọi và cơ cấu chi tiết của guide.
...
|---|---|---|
| Trần Hữu Đức — 2A202602459 | Spec, evidence, điều phối, validation, demo | Canvas/spec; số đếm và trích dẫn; nhật ký dùng thử; nội dung pitch và nộp checkpoint |
